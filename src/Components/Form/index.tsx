        ...
        <div className="flex justify-center p-4 text-center rounded-lg md:flex md:items-center md:p-6 ">
            <form onSubmit={handleSubmit} className="max-w-3xl">
                ...
                <div className="mb-6 flex flex-col md:flex-row justify-evenly" >
                    ...
                    <button type="button" onClick={makeItToday} className="text-white mt-2 md:mt-0 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Aujourd'hui</button>
                </div>
            </form>
        </div>
    )
